 ...
 * @author Doddc
 */
public class ItemDetailManagementPanel extends JPanel {
    ...
    public ItemDetailManagementPanel() {
                ...
                sbtn.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (flag) {
                            ...
                            try {
                                PreparedStatement pstmt = DataOnly.conData.con.prepareStatement("insert into ItemDetailTB values(?,?,?,?,?)");
            ...
            public void actionPerformed(ActionEvent e) {
                if (table.getSelectedRow() != -1) {
                    if (JOptionPane.showConfirmDialog(DataOnly.mainFrame.maF, GetLanguageName.getName("delete"), "提示",
                        ...
                        try {
                            PreparedStatement pstmt = DataOnly.conData.con.prepareStatement("Delete from ItemDetailTB where Item_Id=?");
                    ...
                    sbtn.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (flag) {
                                ...
                                try {
                                    PreparedStatement pstmt = DataOnly.conData.con.prepareStatement("update ItemDetailTB set Item_NameCN=?,Item_NameEN=?,supplier=?,descriptions=?,price=?"
                                            + " where Item_Id=?");
                                    for (int i = 1; i < itemStrings.size(); i++) {
                                        pstmt.setString(i, itemStrings.get(i));
                                    }
                                    pstmt.setString(6, itemStrings.get(0));
                                    pstmt.executeUpdate();
                                    upPanel.remove(oldPanel);
                                    upPanel.add(btnPanel);
                                    upPanel.validate();
